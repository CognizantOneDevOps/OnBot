...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["help","getDeployedBots","addBot","getConfig","delete","stop","container","getMetrics","getHitmiss","getLogs","getChatlog","getBotDetails","editbot","restart","getBots","tail","setWorkflowFile","getWorkflowFile","reload"]
    message = msg.message
