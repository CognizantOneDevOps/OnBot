...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["help","getDeployedBots","getWorkflowFile","setWorkflowFile","addBot","getConfig","delete","stop","container","getMetrics","getHitmiss","getLogs","getChatlog","getBotDetails","editbot","restart","getBots","tail"]
    message = msg.message
