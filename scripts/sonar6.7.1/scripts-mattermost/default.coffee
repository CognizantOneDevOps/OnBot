...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["list sonar projects","list sonar users","delete sonar user","create sonar user","delete sonar project","grant sonar","revoke sonar","help","create sonar project","reload","getMetrics"]
    message = msg.message
