							...
							if body.errors
								...
								for i in [0... body.measures.length]
									if body.measures[i].metric == 'bug'
										dt += '(unknown) '+body.measures[i].metric+": "+body.measures[i].history[body.measures[i].history.length-1].value+"\n"
									else if body.measures[i].metric == 'code_smells'
										dt += '(menorah) '+body.measures[i].metric+": "+body.measures[i].history[body.measures[i].history.length-1].value+"\n"
									else if body.measures[i].metric == 'coverage'
										dt += '(branch) '+body.measures[i].metric+": "+body.measures[i].history[body.measures[i].history.length-1].value+"\n"
									else if body.measures[i].metric == 'duplicated_lines_density'
										dt += '(stash) '+body.measures[i].metric+": "+body.measures[i].history[body.measures[i].history.length-1].value+"\n"
									else if body.measures[i].metric == 'ncloc'
										dt += "(continue) Lines of Code: "+body.measures[i].history[body.measures[i].history.length-1].value+"\n"
									else if body.measures[i].metric == 'sqale_index'
										dt += "(goldstar) Technical Debt :" +body.measures[i].history[body.measures[i].history.length-1].value+"\n"
									else if body.measures[i].metric == 'vulnerabilities'
										dt += '(failed) '+body.measures[i].metric+": "+body.measures[i].history[body.measures[i].history.length-1].value+"\n"
								msg.send dt
								setTimeout (->eindex.passData dt),1000
