		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.invite.workflowflag
				generate_id.getNextSequence (err,id) ->
					tckid=id
					console.log(tckid);
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,podIp:process.env.MY_POD_IP,"callback_id":"githubinvite",invitee:invitee,reponame:reponame}
