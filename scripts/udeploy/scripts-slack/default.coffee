...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["create security token","view user","delete user","create user","create component","delete resource ","create resource","help","view environment of application ","reload","view component of application","view application","view component","list applications","list resources","list components","deploy"]
    message = msg.message
