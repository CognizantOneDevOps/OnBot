		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.deletefeature.workflowflag == true
				...
				generate_id.getNextSequence (err,id) ->
					...
					message = {"text": "Request from "+payload.username+" to delete feature "+objectid,"attachments": [{"text": "You can Approve or Reject","fallback": "failed to respond","callback_id": "deletefeature","color":"#3AA3E3","attachment_type":"default","actions":[{"name":"Approve","text":"Approve","type":"button","value":tckid},{"name":"Rejected","text": "Reject","type": "button","value": tckid,"style": "danger",confirm: {'title': 'Are you sure?','text': 'Do you want to Reject?','ok_text': 'Reject','dismiss_text': 'No'}}]}]}
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.deleteuserstory.workflowflag == true
				...
				generate_id.getNextSequence (err,id) ->
					...
					message = {"text": "Request from "+payload.username+" to delete userstory "+objectid,"attachments": [{"text": "You can Approve or Reject","fallback": "failed to respond","callback_id": "deleteuserstory","color":"#3AA3E3","attachment_type":"default","actions":[{"name":"Approve","text":"Approve","type":"button","value":tckid},{"name":"Rejected","text": "Reject","type": "button","value": tckid,"style": "danger",confirm: {'title': 'Are you sure?','text': 'Do you want to Reject?','ok_text': 'Reject','dismiss_text': 'No'}}]}]}
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.deletebug.workflowflag == true
				...
				generate_id.getNextSequence (err,id) ->
					...
					message = {"text": "Request from "+payload.username+" to delete bug "+objectid,"attachments": [{"text": "You can Approve or Reject","fallback": "failed to respond","callback_id": "deletebug","color":"#3AA3E3","attachment_type":"default","actions":[{"name":"Approve","text":"Approve","type":"button","value":tckid},{"name":"Rejected","text": "Reject","type": "button","value": tckid,"style": "danger",confirm: {'title': 'Are you sure?','text': 'Do you want to Reject?','ok_text': 'Reject','dismiss_text': 'No'}}]}]}
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.deletetask.workflowflag == true
				...
				generate_id.getNextSequence (err,id) ->
					...
					message = {"text": "Request from "+payload.username+" to delete task "+objectid,"attachments": [{"text": "You can Approve or Reject","fallback": "failed to respond","callback_id": "deletetask","color":"#3AA3E3","attachment_type":"default","actions":[{"name":"Approve","text":"Approve","type":"button","value":tckid},{"name":"Rejected","text": "Reject","type": "button","value": tckid,"style": "danger",confirm: {'title': 'Are you sure?','text': 'Do you want to Reject?','ok_text': 'Reject','dismiss_text': 'No'}}]}]}
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.deletetestcase.workflowflag == true
				...
				generate_id.getNextSequence (err,id) ->
					...
					message = {"text": "Request from "+payload.username+" to delete testcase "+objectid,"attachments": [{"text": "You can Approve or Reject","fallback": "failed to respond","callback_id": "deletetestcase","color":"#3AA3E3","attachment_type":"default","actions":[{"name":"Approve","text":"Approve","type":"button","value":tckid},{"name":"Rejected","text": "Reject","type": "button","value": tckid,"style": "danger",confirm: {'title': 'Are you sure?','text': 'Do you want to Reject?','ok_text': 'Reject','dismiss_text': 'No'}}]}]}
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.deleterelease.workflowflag == true
				...
				generate_id.getNextSequence (err,id) ->
					...
					message = {"text": "Request from "+payload.username+" to delete release "+objectid,"attachments": [{"text": "You can Approve or Reject","fallback": "failed to respond","callback_id": "deleterelease","color":"#3AA3E3","attachment_type":"default","actions":[{"name":"Approve","text":"Approve","type":"button","value":tckid},{"name":"Rejected","text": "Reject","type": "button","value": tckid,"style": "danger",confirm: {'title': 'Are you sure?','text': 'Do you want to Reject?','ok_text': 'Reject','dismiss_text': 'No'}}]}]}
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.deleteiteration.workflowflag == true
				...
				generate_id.getNextSequence (err,id) ->
					...
					message = {"text": "Request from "+payload.username+" to delete iteration "+objectid,"attachments": [{"text": "You can Approve or Reject","fallback": "failed to respond","callback_id": "deleteiteration","color":"#3AA3E3","attachment_type":"default","actions":[{"name":"Approve","text":"Approve","type":"button","value":tckid},{"name":"Rejected","text": "Reject","type": "button","value": tckid,"style": "danger",confirm: {'title': 'Are you sure?','text': 'Do you want to Reject?','ok_text': 'Reject','dismiss_text': 'No'}}]}]}
