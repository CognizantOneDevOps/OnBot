...
var deleteepic = function (url, username, password, objectid, callback){
var options = { 
  url: url+"portfolioitem/initiative/"+objectid,
...
module.exports = {
  deleteepic: deleteepic	// MAIN FUNCTION
