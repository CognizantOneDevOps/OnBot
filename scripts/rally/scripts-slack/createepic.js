...
var createepic = function (url, username, password, name, desc, state, callback){
var epicbody={
  "Epic": {
    "Name": name,
    "Description": desc,
...
var options = { 
  url: url+"portfolioitem/initiative/create",
...
request(options, function (error, response, body) {
			...
			if (body){
			var message="EpicName \t\t\t EpicRef \t\t\t EpicId \t\t\t WorkspaceName \t\t\t WorkspaceId \n"
			if (response.statusCode==200)
			{
...
module.exports = {
  createepic: createepic	// MAIN FUNCTION
