...
var deletetask = function (url, username, password, objectid, callback){
console.log(url+"task/"+objectid)
var options = { 
  url: url+"task/"+objectid,
...
module.exports = {
  deletetask: deletetask	// MAIN FUNCTION
