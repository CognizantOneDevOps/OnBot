...
/*Description:
 deletes an iteration from CARally
...
var deleteiteration = function (url, username, password, objectid, callback){
var options = { 
  url: url+"iteration/"+objectid,
...
module.exports = {
  deleteiteration: deleteiteration	// MAIN FUNCTION
