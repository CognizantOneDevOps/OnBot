...
/*Description:
 deletes a feature from CARally
...
var deletefeatures = function (url, username, password, objectid, callback){
var options = { 
  url: url+"portfolioitem/feature/"+objectid,
...
module.exports = {
  deletefeatures: deletefeatures	// MAIN FUNCTION
