...
/*Description:
 deletes a test case from CARally
...
var deletetestcase = function (url, username, password, objectid, callback){
var options = { 
  url: url+"testcase/"+objectid,
...
module.exports = {
  deletetestcase: deletetestcase	// MAIN FUNCTION
