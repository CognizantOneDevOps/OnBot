...
/*Description:
 deletes a release from CARally
...
var deleterelease = function (url, username, password, objectid, callback){
var options = { 
  url: url+"release/"+objectid,
...
module.exports = {
  deleterelease: deleterelease	// MAIN FUNCTION
