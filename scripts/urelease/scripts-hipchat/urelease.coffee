...
module.exports = (robot) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleaselistroles.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleaselistroles.admin,podIp:pod_ip,message:msg.message.text}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleaselistroles.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleaselistroles.admin
	...
	robot.respond /list users/i, (msg) ->
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleaselist_users.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleaselist_users.admin,podIp:pod_ip,message:msg.message.text}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleaselist_users.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleaselist_users.admin
					dataToInsert = {ticketid: tckid, payload: payload, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
	...
	robot.respond /list releases/i, (msg) ->
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleaselist_release.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleaselist_release.admin,podIp:pod_ip,message:msg.message.text}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleaselist_release.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleaselist_release.admin
					dataToInsert = {ticketid: tckid, payload: payload, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
	...
	robot.respond /list applications/i, (msg) ->
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleaselist_application.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleaselist_application.admin,podIp:pod_ip,message:msg.message.text}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleaselist_application.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleaselist_application.admin
					dataToInsert = {ticketid: tckid, payload: payload, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
	...
	robot.respond /create application (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasecreate_app.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={"callback_id": 'ureleasecreate_app',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasecreate_app.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid,app_name:app_name}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasecreate_app.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasecreate_app.admin
					
					dataToInsert = {ticketid: tckid, payload: payload, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
					
			else
				create_app.create_app urelease_url, urelease_user_id, urelease_password, app_name, (error, stdout, stderr) ->
					if error == "null"
						msg.send stdout;
						setTimeout (->index.passData stdout),1000
						message=msg.match[0]
	...
	robot.router.post '/ureleasecreate_app', (request, response) ->
		...
		if data_http.action == 'Approve'
			create_app.create_app urelease_url, urelease_user_id, urelease_password, data_http.app_name, (error, stdout, stderr) ->
				if error == "null"
	...
	robot.respond /create user/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasecreate_user.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={"callback_id": 'ureleasecreate_user',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasecreate_user.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasecreate_user.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasecreate_user.admin
	...
	robot.respond /create release/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasecreate_release.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={"callback_id": 'ureleasecreate_release',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasecreate_release.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasecreate_release.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasecreate_release.admin
	...
	robot.respond /create role (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasecreate_role.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={"callback_id": 'ureleasecreate_role',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasecreate_role.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid,role_name:role_name}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasecreate_role.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasecreate_role.admin
	...
	robot.respond /delete application (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasedelete_application.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={"callback_id": 'ureleasedelete_application',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasedelete_application.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid,app_name:app_name}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasedelete_application.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasedelete_application.admin
	...
	robot.respond /delete user (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasedelete_user.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={"callback_id": 'ureleasedelete_user',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasedelete_user.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid,app_name:app_name}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasedelete_user.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasedelete_user.admin
					dataToInsert = {ticketid: tckid, payload: payload, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else
				delete_application.delete_application urelease_url, urelease_user_id, urelease_password, app_name, (error, stdout, stderr) ->
	...
	robot.respond /delete role (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasedelete_role.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={"callback_id": 'ureleasedelete_role',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasedelete_role.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid,app_name:app_name}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasedelete_role.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasedelete_role.admin
	...
	robot.respond /delete release (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasedelete_release.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={"callback_id": 'ureleasedelete_release',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasedelete_release.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid,app_name:app_name}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasedelete_release.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasedelete_release.admin
	...
	robot.respond /delete initiative (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasedelete_initiatives.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={"callback_id": 'ureleasedelete_initiatives',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasedelete_initiatives.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid,role_name:role_name}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasedelete_initiatives.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasedelete_initiatives.admin
					dataToInsert = {ticketid: tckid, payload: payload, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
	...
	robot.respond /create initiative (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleasecreate_initiative.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					ipayload={"callback_id": 'ureleasecreate_initiative',botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleasecreate_initiative.admin,podIp:pod_ip,message:msg.message.text,tckid:tckid,app_name:app_name}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleasecreate_initiative.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleasecreate_initiative.admin
					dataToInsert = {ticketid: tckid, payload: payload, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
					
			else
				create_initiative.create_initiative urelease_url, urelease_user_id, urelease_password, app_name, (error, stdout, stderr) ->
					if error == "null"
						msg.send stdout;
						message=msg.match[0]
	...
	robot.router.post '/ureleasecreate_initiative', (request, response) ->
		data_http = if request.body.payload? then JSON.parse request.body.payload else request.body
		if data_http.action == 'Approve'
			create_initiative.create_initiative urelease_url, urelease_user_id, urelease_password, data_http.app_name, (error, stdout, stderr) ->
				if error == "null"
					msg.send stdout;
					setTimeout (->index.passData stdout),1000;
					message=data_http.message
	...
	robot.respond /list initiatives/i, (msg) ->
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.ureleaselist_initiatives.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.ureleaselist_initiatives.admin,podIp:pod_ip,message:msg.message.text}
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: ';
					robot.messageRoom(stdout.ureleaselist_initiatives.admin, data);
					msg.send 'Your request is waiting for approval by '+stdout.ureleaselist_initiatives.admin
					dataToInsert = {ticketid: tckid, payload: payload, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
