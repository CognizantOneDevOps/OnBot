...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["start watching","list users","list roles","list releases","reload","list applications","list initiatives","create user","create initiative","create application","create release","create role","delete initiative","delete role","delete user","help","delete application","delete release"]
    message = msg.message
