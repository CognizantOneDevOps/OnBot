		...
		run_job_status = () ->
			...
			request.get options, (error, response, body) ->
				...
				if body.result != "FAILURE"
					...
					dt = {"attachments": [{"fallback": "Build finished","text": "Build finished","fields": [{"title": "Job name","value": body.fullDisplayName,"short": true},{"title": "Status","value": "FAILURE","short": true},{"title": "Build Completion Time","value": new Date(body.timestamp),"short": true}],"color": "#7CD197"}]}
