...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["create job","upload","give","restart jenkins","install","reload","jenkins list","jenkins build","start","delete job","install","restart jenkins","jenkins describe","help"]
    message = msg.message
