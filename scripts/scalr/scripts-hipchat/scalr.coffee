...
module.exports = (robot) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.printscalrfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.printscalrfarm.admin,podIp:pod_ip,callback_id:'printscalrfarm',message:msg.message.text};
					text_in_json_slack = 'Approve Request for view farm list from '.concat(msg.message.user.name);
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: print scalr farms \n approve or reject the request';
					robot.messageRoom stdout.printscalrfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.printscalrfarm.admin);
	...
	robot.respond /print scalr scripts/i, (msg) ->
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.printscalrscripts.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.printscalrscripts.admin,podIp:pod_ip,callback_id: 'printscalrscripts',message:msg.message.text};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: print scalr scripts \n approve or reject the request';
					robot.messageRoom stdout.printscalrscripts.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.printscalrscripts.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else
	...
	robot.respond /print scalr server (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.printscalrserver.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.printscalrserver.admin,podIp:pod_ip,callback_id: 'printscalrserver',message:msg.message.text,farm_id:farm_id};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: print scalr server \n approve or reject the request';
					robot.messageRoom stdout.printscalrserver.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.printscalrserver.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else
	...
	robot.respond /print scalr role (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.printscalrroles.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.printscalrroles.admin,podIp:pod_ip,callback_id: 'printscalrroles',message:msg.message.text,farm_id:farm_id};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: print scalr role \n approve or reject the request';
					robot.messageRoom stdout.printscalrroles.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.printscalrroles.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else 
	...
	robot.respond /print scalr farm (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.printscalrspecificfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.printscalrspecificfarm.admin,podIp:pod_ip,callback_id: 'printscalrspecificfarm',message:msg.message.text,farm_name:farm_name};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: print scalr farm \n approve or reject the request';
					robot.messageRoom stdout.printscalrspecificfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.printscalrspecificfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else 
	...
	robot.respond /execute script (.*) in server (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.executescriptinfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.executescriptinfarm.admin,podIp:pod_ip,callback_id: 'executescriptinfarm',message:msg.message.text,script_id:script_id,server_id:server_id};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: execute script \n approve or reject the request';
					robot.messageRoom stdout.executescriptinfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.executescriptinfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else 
	...
	robot.respond /create farm (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.createscalrfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.createscalrfarm.admin,podIp:pod_ip,callback_id: 'createscalrfarm',message:msg.message.text,farm_name:farm_name};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: create farm \n approve or reject the request';
					robot.messageRoom stdout.createscalrfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.createscalrfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else	
	...
	robot.respond /create role (.*) in (.*) on (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.createscalrroleinfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.createscalrroleinfarm.admin,podIp:pod_ip,callback_id: 'createscalrroleinfarm',message:msg.message.text,farm_name:farm_name,role_name:role_name,os_name:os_name};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: create role \n approve or reject the request';
					robot.messageRoom stdout.createscalrroleinfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.createscalrroleinfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else	
	...
	robot.router.post '/createscalrroleinfarm', (request, response) ->
		...
		if data_http.action == 'Approved'					
			robot.messageRoom data_http.userid, 'Your request is approved by '.concat(data_http.approver);		
			role_create.role_create scalr_url, scalr_access_id, scalr_access_key, data_http.env_id, data_http.farm_name, data_http.role_name, os_name, (coffee_error, coffee_stdout, coffee_stderr) ->
				if coffee_error == null
	...
	robot.respond /delete farm (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.deletescalrfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					message_to_approve = 'Approve Request for delete farm with ID : '.concat(farm_name);
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.deletescalrfarm.admin,podIp:pod_ip,callback_id: 'deletescalrfarm',message:msg.message.text,farm_name:farm_name};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: delete farm \n approve or reject the request';
					robot.messageRoom stdout.deletescalrfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.deletescalrfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else	
	...
	robot.respond /launch farm (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.launchscalrfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					message_to_approve = 'Approve Request for launch farm with ID : '.concat(farm_id);
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.launchscalrfarm.admin,podIp:pod_ip,callback_id: 'launchscalrfarm',message:msg.message.text,farm_id:farm_id};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: launch farm \n approve or reject the request';
					robot.messageRoom stdout.launchscalrfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.launchscalrfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else	
	...
	robot.router.post '/launchscalrfarm', (request, response) ->
		data_http   = if request.body.payload? then JSON.parse request.body.payload else request.body
		#robot.messageRoom data_http.userid, data_http.action
		#robot.messageRoom data_http.userid, 'coming here'
		if data_http.action == 'Approved'
			robot.messageRoom data_http.userid, 'Your request is approved by '.concat(data_http.approver);
	...
	robot.respond /resume farm (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.resumescalrfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.resumescalrfarm.admin,podIp:pod_ip,callback_id: 'resumescalrfarm',message:msg.message.text,farm_id:farm_id};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: resume farm \n approve or reject the request';
					robot.messageRoom stdout.resumescalrfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.resumescalrfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else 
	...
	robot.respond /suspend farm (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.suspendscalrfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					message_to_approve = 'Approve Request for suspend farm with ID : '.concat(farm_id);
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.suspendscalrfarm.admin,podIp:pod_ip,callback_id: 'suspendscalrfarm',message:msg.message.text,farm_id:farm_id};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: suspend farm \n approve or reject the request';
					robot.messageRoom stdout.suspendscalrfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.suspendscalrfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else
	...
	robot.respond /terminate farm (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.terminatecalrfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					message_to_approve = 'Approve Request for terminate farm with ID : '.concat(farm_id);
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.terminatecalrfarm.admin,podIp:pod_ip,callback_id: 'terminatecalrfarm',message:msg.message.text,farm_id:farm_id};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: terminate farm \n approve or reject the request';
					robot.messageRoom stdout.terminatecalrfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.terminatecalrfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else
	...
	robot.respond /clone farm (.*) to (.*)/i, (msg) ->
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			if stdout.clonescalrfarm.workflowflag == true
				generate_id.getNextSequence (err,id) ->
					tckid=id
					message_to_approve = 'Approve Request for clone farm with ID : '.concat(farm_id);
					json={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,approver:stdout.clonescalrfarm.admin,podIp:pod_ip,callback_id: 'clonescalrfarm',message:msg.message.text,farm_id:farm_id,new_farm_name:new_farm_name};
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: clone farm \n approve or reject the request';
					robot.messageRoom stdout.clonescalrfarm.adminid, data;
					msg.reply 'Your approval request is waiting from '.concat(stdout.clonescalrfarm.admin);
					dataToInsert = {ticketid: tckid, payload: json, "status":"","approvedby":""}
					generate_id.add_in_mongo dataToInsert
			else
