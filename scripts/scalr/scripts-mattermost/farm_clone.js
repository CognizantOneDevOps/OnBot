...
var function_call = function (main_scalr_url, access_id, access_key, envid, farmid, farm_name, callback_farm_clone) {
...
request(options, function (error, response, body) {
	console.log(body);
  if (error){
	  callback_farm_clone("Something went wrong","Something went wrong","Something went wrong");
  }
  else if(response.statusCode == 201)
  {

	  callback_farm_clone(null,response.body.data.id,null);
...
module.exports = {
 farm_clone: function_call	// MAIN FUNCTION
