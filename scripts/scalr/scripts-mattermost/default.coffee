...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["reload","print scalr farms","print scalr scripts","print scalr server","print scalr role","print scalr farm","create farm","execute script","launch farm","delete farm","resume farm","suspend farm","terminate farm","clone farm","help","create role"]
    message = msg.message
