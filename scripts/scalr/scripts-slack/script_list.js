...
var function_call = function (main_scalr_url, access_id, access_key, envid, callback_script_list) {
var path = '/api/v1beta0/user/' + envid + '/scripts/';
...
var options = { method: 'GET',
	...
	request(options, function (error, response, body) {
		...
		{
			var z = i+1;
			final_str = final_str + z + " Name: " + body.data[i].name + " ID: " +body.data[i].id+"\n";
		}
		

			if (error)
			{
				callback_script_list("Something went wrong","Something went wrong","Something went wrong");
				
		}		
			else{
				
			callback_script_list(null,final_str,null);
...
module.exports = {
 script_list: function_call	// MAIN FUNCTION
