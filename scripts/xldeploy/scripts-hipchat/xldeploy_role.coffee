		...
		#Action Flow with workflow flag
			if(stdout.deleterole.workflowflag)
				...
				generate_id.getNextSequence (err,id) ->
					...
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,podIp:process.env.MY_POD_IP,"callback_id":"xldeploy_deleterole","name":name}
		...
		#Action Flow with workflow flag
			if(stdout.getrole.workflowflag)
				...
				generate_id.getNextSequence (err,id) ->
					tckid=id
					#Prepare payload for Hipchat	
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,podIp:process.env.MY_POD_IP,"callback_id":"xldeploy_getrole"}
					message='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: getting roles \n approve or reject the request'
		...
		#Action Flow with workflow flag
			if(stdout.getuser.workflowflag)
				...
				generate_id.getNextSequence (err,id) ->
					tckid=id
					#Prepare payload for Hipchat	
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,podIp:process.env.MY_POD_IP,"callback_id":"xldeploy_getuser","name":name}
					message='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: gettting user info of '+name+'\n approve or reject the request'
		...
		#Action Flow with workflow flag
			if(stdout.createuser.workflowflag)
				...
				generate_id.getNextSequence (err,id) ->
					tckid=id
					#Prepare payload for Hipchat	
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,podIp:process.env.MY_POD_IP,"callback_id":"xldeploy_createuser","name":name,"pwd":pwd}
		...
		#Action Flow with workflow flag
			if(stdout.deleteuser.workflowflag)
				...
				generate_id.getNextSequence (err,id) ->
					tckid=id
					#Prepare payload for Hipchat	
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,podIp:process.env.MY_POD_IP,"callback_id":"xldeploy_deleteuser","name":name}
					message='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: deleteuser '+name+' \n approve or reject the request'
		...
		#Action Flow with workflow flag
			if(stdout.assignrole.workflowflag)
				...
				generate_id.getNextSequence (err,id) ->
					tckid=id
					#Prepare payload for Hipchat	
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,podIp:process.env.MY_POD_IP,"callback_id":"xldeploy_assignrole","name":name,"role":role}
					message='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: for assigned role '+role +' to '+name+' \n approve or reject the request'
		...
		#Action Flow with workflow flag
			if(stdout.delassignrole.workflowflag)
				...
				generate_id.getNextSequence (err,id) ->
					tckid=id
					#Prepare payload for Hipchat	
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,podIp:process.env.MY_POD_IP,"callback_id":"xldeploy_delassignrole","name":name,"role":role}
					message='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: for delete assigned role '+role +' to '+name+'\n approve or reject the request'
		...
		#Action Flow with workflow flag
			if(stdout.getrepo.workflowflag)
				...
				generate_id.getNextSequence (err,id) ->
					tckid=id
					#Prepare payload for Hipchat	
					payload={botname:process.env.HUBOT_NAME,username:msg.message.user.name,userid:msg.message.user.reply_to,podIp:process.env.MY_POD_IP,"callback_id":"xldeploy_getrepo"}
					message='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: getrepo \n approve or reject the request'
