...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["reload","help","deploy","create repo","update repo","undeploy","delete repo","create role","delete role","get role","get user","create user","delete user","assign role","delete assignedrole","get repo"]
    message = msg.message
