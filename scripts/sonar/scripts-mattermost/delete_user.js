...
sonar_url = sonar_url+"api/users/deactivate?login="+user_id;
...
request(options, function (error, response, body) {
  ...
  if (error)
  {
	  callback_user_delete("Something went wrong","Something went wrong",null);
  }
  else if(response.statusCode == 200)
  {
	  callback_user_delete(null,"",null);
  }
  else
  {
	  var str = JSON.stringify(body.errors);
	  callback_user_delete(str,str,str);
  }
