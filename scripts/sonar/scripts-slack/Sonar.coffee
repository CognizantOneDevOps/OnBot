							...
							if body.errors
								...
								for i in [0... body.component.measures.length]
									if body.component.measures[i].metric == 'bugs'
										...
										dt += ':radioactive_sign: '+body.component.measures[i].metric+": "+body.component.measures[i].value+"\n"
										...
										dt += ":spiral_note_pad: Lines of Code: "+body.component.measures[i].value+"\n"
									else if body.component.measures[i].metric == 'sqale_index'
										dt += ":female-technologist: Technical Debt :" +body.component.measures[i].value+"\n"
