...
console.log (response.body.errors);
  if (error)
  {
	  callback_jira("Something went wrong","Something went wrong",error);
  }
  else if(response.body.errors)
  {
	  callback_jira("Correct Issue Type Is Required","Correct Issue Type Is Required",response.body.errors);
  }
  else
  {
	  callback_jira(null,"Successfully Created",null);
  }
});
}
module.exports = {
