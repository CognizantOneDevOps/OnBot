...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["reload","list nexus repos","list nexus users","list nexus repo","list nexus user","create nexus repo","delete nexus repo","create nexus user","list nexus users","delete nexus user","list nexus privileges","create privilege","show artifacts in","help"]
    message = msg.message
