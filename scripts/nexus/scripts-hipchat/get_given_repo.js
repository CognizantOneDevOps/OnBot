...
var function_call = function (nexus_repourl, username, password, repoid, callback_getall_repo) {

var nexus_repourl = nexus_repourl;
var request = require("request");
var url_link = nexus_repourl+"/service/local/repositories/"+repoid;
...
function callback(error, response, body) {
	...
	for(i=1; i<length_check.length; i++)
	{
		...
		final_answer = final_answer + "Name :: "+name[i]+" RepoUrl :: "+url[i]+" Provider :: "+provider[i]+"\n";
...
module.exports = {
  get_given_repo: function_call	// MAIN FUNCTION
