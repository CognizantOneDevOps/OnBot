		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.getartifact.workflowflag
				generate_id.getNextSequence (err,id) ->
					...
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: getArtifact '+artifact+' '+repo+'\n approve or reject the request'
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.createrepo.workflowflag
				generate_id.getNextSequence (err,id) ->
					...
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: createRepo '+repotype+' '+repokey+'\n approve or reject the request'
		...
		readjson.readworkflow_coffee (error,stdout,stderr) ->
			...
			if stdout.deleteartifact.workflowflag
				generate_id.getNextSequence (err,id) ->
					...
					data='Ticket Id : '+tckid+'\n Raised By: '+msg.message.user.name+'\n Command: deleteArtifact '+remote_path+'\n approve or reject the request'
